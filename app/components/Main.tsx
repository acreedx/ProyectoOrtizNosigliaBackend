            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-item mb-30">
                <div className="service-icon mb-25">
                  ...
                  >
                    <g
                      id="noun_Brain_2581553"
                      transform="translate(-5.696 -4.966)"
                    >
                      <path
                        id="Path_66"
                        data-name="Path 66"
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-item mb-30">
                <div className="service-icon mb-25">
                  ...
                  >
                    <g
                      id="noun_knee_joint_2596276"
                      data-name="noun_knee joint_2596276"
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-item mb-30">
                <div className="service-icon mb-25">
                  ...
                  >
                    <g
                      id="noun_womb_1744327"
                      transform="translate(-22.94 -12.449)"
                    >
                      <path
                        id="Path_81"
                        data-name="Path 81"
                  ...
                  <div className="faq-item mb-20">
                    ...
                    >
                      <div className="faq-content">
                        Lorem ipsum dolor sit amet, consetet Lorem ipsum dolor
              ...
              <div className="subscribe-wrapper">
                ...
                <div className="support d-flex">
                  <div className="support-icon">
                    ...
                    >
                      <g
                        id="noun_customer_service_2786300"
                        data-name="noun_customer service_2786300"
                      ...
                      >
                        ...
                        <path
                          ...
                          transform="translate(-6.104 -5.93)"
                          fill="#00adb5"
                        />
                        <path
                          id="Path_96"
                          ...
                          transform="translate(-9.61 -6.012)"
                          fill="#00adb5"
                        />
                      </g>
                    </svg>
